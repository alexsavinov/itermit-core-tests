...
public class AdminUsersCreatePage extends PageTools {

    private final By createUserTitle = By.id("create-user-title");
    private final By inputUsername = By.id("username");
    private final By errorUsername = By.id("username-error");
    private final By inputPassword = By.id("password");
    private final By errorPassword = By.id("password-error");
    private final By inputConfirmPassword = By.id("confirm-password");
    private final By errorConfirmPassword = By.id("confirm-password-error");
    ...
    public void waitForLoad() {
        Selenide.sleep(100);
        $(createUserTitle).shouldBe(Condition.visible);
    }
    ...
    public String getCreateUserTitleText() {
        return getElementText(createUserTitle);
    }

    public void setInputUsernameValue(String value) {
        type(value, inputUsername);
        focus();
    }
    ...
    public void setInputConfirmPasswordValue(String value) {
        type(value, inputConfirmPassword);
        focus();
    }
