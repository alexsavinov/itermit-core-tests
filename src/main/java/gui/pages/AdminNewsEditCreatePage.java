...
//    private final By inputContent = By.xpath("//div[contains(@class, 'tox-editor-container')]");
    private final By iframe = By.xpath("//iframe[@title='Rich Text Area']");
    private final By inputContent = By.id("tinymce");
//    private final By inputContent = By.xpath("//body[@id='tinymce']");
...
//        $(inputPublishDate).sendKeys(value);
