...
public class AdminUsersListPage extends PageTools {
    ...
    private final By sortByName = By.xpath("(//div[contains(@class, 'mat-sort-header-container')])[4]");
    private final By editButton = By.xpath("(//td//mtx-grid-cell//button)[5]");
    private final By deleteButton = By.xpath("(//td//mtx-grid-cell//button)[2]");
